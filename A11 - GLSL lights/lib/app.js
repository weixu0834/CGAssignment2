...
var reqData = [
	{text: "Single directional light, constant ambient",
	...
	{text: "Single point light without decay",
	...
	{text: "Single spot light (without decay), constant ambient",
	 sel: {	ambientType: "ambient",
			diffuseType: "lambert",
			specularType: "blinn",
			lightType: "spot",
	...
	{text: "Single point light with decay",
	 sel: {	ambientType: "none",
			diffuseType: "lambert",
			specularType: "blinn",
			lightType: "point",
	...
	{text: "Single spot light (with decay)",
	 sel: {	ambientType: "none",
			diffuseType: "lambert",
			specularType: "blinn",
			lightType: "spot",
	...
	{text: "Single point light, hemispheric ambient",
	...
	{text: "Single spot light, spherical harmonics ambient",
	 sel: {	ambientType: "SH",
			diffuseType: "lambert",
			specularType: "blinn",
			lightType: "spot",
...
var fs2 = `	
	...
	// Diffuse
	vec4 diffuse = compDiffuse(OlightDir, OlightColor, normalVec, diffColor);
	
	// Specular
	// --> Phong
	vec4 specular = compSpecular(OlightDir, OlightColor, normalVec, eyedirVec);
