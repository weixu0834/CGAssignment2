...
function InitTransforms() {
	...
	sTransformText[0] = "Translate of +1 on the x axis, and -2 on the y axis";
	sTransform[0] = utils.MakeTranslateMatrix(1,-2,0);
	
	sTransformText[1] = "Rotate of 30 degrees on the x axis";
	sTransform[1] = utils.MakeRotateXMatrix(30);
	
	sTransformText[2] = "Make the object 2 times bigger";
	sTransform[2] = utils.MakeScaleMatrix(2);
	...
	sTransformText[4] = "Mirror over the y axis";
	sTransform[4] = utils.MakeScaleNuMatrix(-1, 1, -1);
	       
	sTransformText[5] = "Flatten over the x axis";
	sTransform[5] = utils.MakeScaleNuMatrix(0, 1, 1);
	       
	sTransformText[6] = "Make a shear along the Y axis, with a factor of 1 along the z axis";
	sTransform[6] = utils.MakeShearYMatrix(0, 1);
